let users = {
    ...
    tylermcginnis: {
        ...
        name: 'Tyler McGinnis',
        avatarURL:
            'https://www.archeoares.it/wp-content/uploads/2020/12/avatar-man.png',
        answers: {
    ...
    johndoe: {
        ...
        name: 'John Doe',
        avatarURL:
            'https://www.kavs.uniza.sk/images/Avatar_img/avatar-user-student-3e3e52aa56aeb627-512x512.png',
        answers: {
